...
STATINLINE vmask vandnot_vm_vo64_vm(vopmask x, vmask y) { return vreinterpret_vm_vd(_mm256_andnot_pd(vreinterpret_vd_vm(x), vreinterpret_vd_vm(y))); }
...
CONST vdouble Sleef_expd4_u10avx2(vdouble d) {
  ...
  u = vmla_vd_vd_vd_vd((s8), (vmla_vd_vd_vd_vd((s), (vcast_vd_d(+0.2081276378237164457e-8)), (vcast_vd_d(+0.2511210703042288022e-7)))), (vmla_vd_vd_vd_vd((s4), (vmla_vd_vd_vd_vd((s2), (vmla_vd_vd_vd_vd((s), (vcast_vd_d(+0.2755762628169491192e-6)), (vcast_vd_d(+0.2755723402025388239e-5)))), (vmla_vd_vd_vd_vd((s), (vcast_vd_d(+0.2480158687479686264e-4)), (vcast_vd_d(+0.1984126989855865850e-3)))))), (vmla_vd_vd_vd_vd((s2), (vmla_vd_vd_vd_vd((s), (vcast_vd_d(+0.1388888888914497797e-2)), (vcast_vd_d(+0.8333333333314938210e-2)))), (vmla_vd_vd_vd_vd((s), (vcast_vd_d(+0.4166666666666602598e-1)), (vcast_vd_d(+0.1666666666666669072e+0)))))))));
...
STATINLINE vmask vandnot_vm_vo32_vm_sp(vopmask x, vmask y) { return vreinterpret_vm_vd_sp(_mm256_andnot_pd(vreinterpret_vd_vm_sp(x), vreinterpret_vd_vm_sp(y))); }
...
STATINLINE vopmask vlt_vo_vf_vf_sp(vfloat x, vfloat y) { return vreinterpret_vm_vf_sp(_mm256_cmp_ps(x, y, 
                                                                                                      0x11
                                                                                                                )); }
...
STATINLINE CONST vfloat vldexp2_vf_vf_vi2_sp(vfloat d, vint2 e) {
  return vmul_vf_vf_vf_sp(vmul_vf_vf_vf_sp(d, vpow2i_vf_vi2_sp(vsra_vi2_vi2_i_sp(e, 1))), vpow2i_vf_vi2_sp(vsub_vi2_vi2_vi2_sp(e, vsra_vi2_vi2_i_sp(e, 1))));
}
...
CONST vdouble Sleef_logd4_u10avx2(vdouble d) {
  ...
  t = vmla_vd_vd_vd_vd((x8), (vmla_vd_vd_vd_vd((x4), (vcast_vd_d(0.1532076988502701353e+0)), (vmla_vd_vd_vd_vd((x2), (vcast_vd_d(0.1525629051003428716e+0)), (vcast_vd_d(0.1818605932937785996e+0)))))), (vmla_vd_vd_vd_vd((x4), (vmla_vd_vd_vd_vd((x2), (vcast_vd_d(0.2222214519839380009e+0)), (vcast_vd_d(0.2857142932794299317e+0)))), (vmla_vd_vd_vd_vd((x2), (vcast_vd_d(0.3999999999635251990e+0)), (vcast_vd_d(0.6666666666667333541e+0)))))));
  ...
  r = vsel_vd_vo_vd_vd(vor_vo_vo_vo(vlt_vo_vd_vd(d, vcast_vd_d(0)), visnan_vo_vd(d)), vcast_vd_d(__builtin_nan("")), r);
  r = vsel_vd_vo_vd_vd(veq_vo_vd_vd(d, vcast_vd_d(0)), vcast_vd_d(-__builtin_inf()), r);
  return r;
}
...
CONST vdouble Sleef_logd4_u35avx2(vdouble d) {
  ...
  t = vmla_vd_vd_vd_vd((x8), (vmla_vd_vd_vd_vd((x4), (vcast_vd_d(0.153487338491425068243146)), (vmla_vd_vd_vd_vd((x2), (vcast_vd_d(0.152519917006351951593857)), (vcast_vd_d(0.181863266251982985677316)))))), (vmla_vd_vd_vd_vd((x4), (vmla_vd_vd_vd_vd((x2), (vcast_vd_d(0.222221366518767365905163)), (vcast_vd_d(0.285714294746548025383248)))), (vmla_vd_vd_vd_vd((x2), (vcast_vd_d(0.399999999950799600689777)), (vcast_vd_d(0.6666666666667778740063)))))));
...
STATINLINE vopmask vor_vo_vo_vo_sp(vopmask x, vopmask y) { return vreinterpret_vm_vd_sp(_mm256_or_pd(vreinterpret_vd_vm_sp(x), vreinterpret_vd_vm_sp(y))); }
...
STATINLINE vopmask veq_vo_vf_vf_sp(vfloat x, vfloat y) { return vreinterpret_vm_vf_sp(_mm256_cmp_ps(x, y, 
                                                                                                      0x00
                                                                                                                )); }

STATINLINE vopmask vneq_vo_vf_vf_sp(vfloat x, vfloat y) { return vreinterpret_vm_vf_sp(_mm256_cmp_ps(x, y, 
                                                                                                       0x04
                                                                                                                  )); }

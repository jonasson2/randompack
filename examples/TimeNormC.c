// -*- C -*-
// TimeNormC.c: time normal distribution draws (ns/value), double and float.
...
static void print_help(void) {
  printf("TimeNormC — time normal distribution draws (ns/value), double and float\n");
  printf("Usage: TimeNormC [options]\n\n");
  printf("Options:\n");
  printf("  -h            Show this help message\n");
  printf("  -e engine     RNG engine (default x256++simd)\n");
  printf("  -t seconds    Benchmark time per run (default 0.3)\n");
...
static void fill_normref(double out[], int n, double param[], randompack_rng *rng) {
  (void)param;

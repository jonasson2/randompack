...
documentation of engines and distributions, see the main project readme file on
github/jonasson2/randompack. The same page also links to DEVELOPMENT.md, which contains
setup and development instructions, including details specific to the R interface.
